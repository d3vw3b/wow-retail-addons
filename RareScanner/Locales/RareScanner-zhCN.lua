...
if AL then
	...
	AL["ALARM_SOUND"] = "稀有NPC警告音"
	AL["ALARM_SOUND_DESC"] = "当稀有NPC显示在小地图时播放音效"
	AL["ALARM_TREASURES_SOUND"] = "事件/宝箱提示音"
	...
	AL["CMD_HIDE"] = "正在隐藏世界地图上的RareScanner图标"
	AL["CMD_SHOW"] = "正在显示世界地图上的RareScanner图标"
	AL["CONTAINER"] = "宝箱"
	AL["DATABASE_HARD_RESET"] = "因为资料片更新以及RareScanner的大更新导致数据库变更，需要重置数据库避免数据不一致。我们对带来的不便深感抱歉。"
	AL["DISABLE_SEARCHING_RARE_TOOLTIP"] = "禁用对此NPC的警报"
	...
	AL["DISPLAY_MAP_NOT_DISCOVERED_ICONS_DESC"] = "禁用时，未发现的稀有NPC（红色和橙色图标）、宝箱和事件不会在地图上显示"
	AL["DISPLAY_MAP_OLD_NOT_DISCOVERED_ICONS"] = "旧资料片未发现图标显示开关"
	AL["DISPLAY_MAP_OLD_NOT_DISCOVERED_ICONS_DESC"] = "禁用时，旧资料片区域中尚未发现的稀有NPC（红色和橙色图标）、宝箱和事件不会在地图上显示"
	...
	AL["ENABLED_SEARCHING_RARE"] = "已启用警报的稀有NPC："
	AL["EVENT"] = "事件"
	AL["FILTER"] = "NPC过滤"
	AL["FILTER_CONTINENT"] = "大陆/星球"
	AL["FILTER_CONTINENT_DESC"] = "大陆名或星球名"
	AL["FILTER_NPCS_ONLY_MAP"] = "只在世界地图上启用过滤器"
	AL["FILTER_NPCS_ONLY_MAP_DESC"] = "此选项启用时，您仍会收到已过滤稀有NPC的警报，但不会在世界地图上显示。当停用此选项时，您不会收到已过滤稀有NPC的警报。"
	...
	AL["FILTER_ZONES_ONLY_MAP_DESC"] = "此选项启用时，您仍会收到已过滤地区中稀有NPC的警报，但不会在世界地图上显示。当停用此选项时，您不会收到已过滤地区中稀有NPC的警报。"
	AL["FILTERS"] = "稀有NPC过滤"
	...
	AL["NOTE_135497"] = "仅在米露恩发放日常任务[来自诺达希尔的援助]时有效。该日常要求你在树底下找蘑菇，当你点击一个蘑菇时它会停滞，你需要在它消失前再点2个蘑菇，NPC才会出现"
	...
	AL["NOTE_153000"] = "它会在这个区域游荡，所以坐标可能不太精确。"
	...
	AL["NOTE_154225"] = "需要使用[个人时光置换器]切换时空位面，你可以使用麦卡贡的资源制造这个物品，图纸是克罗米发放日常任务[平行空间]时小怪掉落"
	AL["NOTE_154342"] = "需要使用[个人时光置换器]切换时空位面，你可以使用麦卡贡的资源制造这个物品，图纸是克罗米发放日常任务[平行空间]时小怪掉落"
